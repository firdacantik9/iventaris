      ...
      <div class="d-flex justify-content-center align-items-center" style="height: 100vh">
        <div class="text-center">
          ...
          <form action="" method="post">
            Cari berdasarkan
            <Select name="pilih">
              <option value="id_barang">id_barang</option>
              <option value="nama_barang">nama_barang</option>
               <option value="jumlah_barang">jumlah_barang</option>
...
<input type="submit" name="semua" value="Tampilkan Semua">
            ...
            foreach($tampil as $row)
            {
              ?>
               <tr>
                ...
                <td><?php echo "<a href='updatebarang.php?id=$row[id_barang]'>UPDATE</a> | 
                <a href='deletebarang.php?id=$row[id_barang]'>DELETE</a>"; ?></td>
            </tr>
            <?php } ?>
            </table>
    ...
    <!-- MDB -->
    <script type=  t/javascript" src="js/mdb.min.js"></script>
    <!-- Custom scripts -->
